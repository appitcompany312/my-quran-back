...
public class EmailVerificationServiceImpl implements EmailVerificationService {
    ...
    @Override
    public void sendEmail(String email, String name, String token) throws ConflictException {
        if (!isValid(email)) {
            throw new IllegalArgumentException(String.format("%s is not valid", email));
        }

        String link = String.format(url, token, email);

        String message = buildEmail(name, link, token);
    ...
    private String buildEmail(String name, String link, String token) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "\n" + token + " - token will expire in 15 minutes. <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
